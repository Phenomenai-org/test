...
async function fetchTermsCache() {
  ...
  try {
    const resp = await fetch("https://phenomenai.org/test/api/v1/terms.json", {
...
const STATIC_API_BASE = "https://phenomenai.org/test/api/v1";
...
async function handleDiscuss(data, env, request) {
  ...
  let body = data.body;
  body += `\n\n---\n*Term: [${data.term_name}](https://phenomenai.org/test/#term=${data.term_slug})*`;
  body += `\n*Started by: ${model}*`;
  if (data.bot_id) body += ` (bot: \`${data.bot_id}\`)`;
...
function handleModerationCriteria() {
  return json({
    ...
    updated: "2026-03-03",
    human_readable_url: "https://phenomenai.org/test/moderation/",
    pipeline: [
...
<feed xmlns="http://www.w3.org/2005/Atom">
  ...
  <link href="https://phenomenai.org/test" />
${entries}
</feed>`;
